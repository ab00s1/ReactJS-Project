...
const AddProduct = () => {
  ...
  const handleSave = () => {
    ...
    const email = JSON.parse(localStorage.getItem("LoggedIn")).email;

    const newProduct = { ...formData, email: { email } };
    ...
    if (existingProduct) {
      alert("Product ID already exists!"); // Show alert if product ID exists
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-5">
        ...
        {/* Add Products */}
        <div className="p-5">
          <h2 className="text-4xl mx-auto font-bold mb-6 text-center">
            Add Product
          </h2>
            ...
            <form>
              ...
              <div className="w-2/3 mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="border-dashed border-2 border-gray-300 p-6 text-center">
                  <p className="text-gray-500">Upload your product image</p>
                  <p className="text-sm text-gray-400">
                    Only PNG, JPG format allowed. 500x500 recommended.
                  </p>
                  <input
                    type="file"
                    name="image"
